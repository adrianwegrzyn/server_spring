...
public class RSSFeedParser {
    ...
    static final String PHOTO = "enclosure";
                ...
                if (event.isStartElement()) {
                    ...
                    switch (localPart) {
                        case ITEM:
                            if (isFeedHeader) {
                                isFeedHeader = false;
                                feed = new Feed(title, link, description, pubdate, photo);
                            }
                    ...
                    if (event.asEndElement().getName().getLocalPart().equals(ITEM)) {
                        ...
                        SportsNewsDto message = new SportsNewsDto();
                        message.setDatePub(pubdate);
